...
**Next: emotion (pillar 2)** — persist the 6-channel mood + eval (reuse the new `MetaStore`); or continue hardening memory. Delivery layer (proactivity/tools) still gated behind a solid brain.
