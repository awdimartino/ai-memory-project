...
**Next: proactive reach-out (pillar 3, slice 2)** — plug a `ReachOutJob` into the tick that pushes an unprompted, model-generated message to the web UI. Delivery layer still gated behind the (now emotion-complete) brain.
