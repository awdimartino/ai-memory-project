...
**Next: proactivity (pillar 3)** — the tick loop (mood drift on the now-persisted mood, reflection, reach-out gate → unprompted WebSocket push) + sleep/standby. Delivery layer still gated behind the (now emotion-complete) brain.
